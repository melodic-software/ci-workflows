...
caller contains `reopened`; `gh api repos/melodic-software/claude-code-plugins/rulesets`
still lists `security-review / security-review` AND a live PR shows an ACTUAL
